...
const BASE_URLS = {
  domain:          'https://api.builtwith.com/v23/api.json',
  ...
  trust:           'https://api.builtwith.com/trustv2/api.json',
  vat:             'https://api.builtwith.com/vat1/api.json',
  'vat-types':     'https://api.builtwith.com/vat1/types.json',
  'mcp-registry':  'https://api.builtwith.com/mcp1/api.json',
  'mcp-registry-v2':  'https://api.builtwith.com/mcp2/api.json',
  vector:          'https://api.builtwith.com/vector/v1/api.json',
  'keyword-search': 'https://api.builtwith.com/kws1/api.json',
  ask:             'https://api.builtwith.com/ask1/api.json',
